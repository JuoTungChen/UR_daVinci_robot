    ...
    return LaunchDescription([
        ...
        Node(package='eua_control',
            ...
            parameters=[{
                ...
                'baud_rate': 2000000,
                'prefix': 'b_tool_',
                'joint_device_mapping': {'roll': 22, 'pitch': 21, 'yaw1': 20, 'yaw2': 23},
                'homing_load_thresholds': [0.1, 0.08, 0.07, 0.06],
            }],
        ),
        ...
        #     }],
        # ),        
        # Node(package='force_dimension',
        #     executable='force_dimension',
        #     # namespace='/b',
        # ),         
        ...
        Node(package='mops_state_publisher_moveit',
            executable='mops_remapper',
            parameters=[{
                'joint_states_topic_1': "b/ur/joint_states",
                'joint_states_topic_2': "b/tool/joint_states",
                'prefix1': "b_ur_",
                'prefix2': "b_tool_",
            }],
            # name='force_dimension_node'
            # namespace='/pedal',
        ),
        ComposableNodeContainer(
            ...
            composable_node_descriptions=[
                ...
                ComposableNode(
                    package='mops_teleop',
                    plugin='mops_teleop::TeleopNodeFD',
                    name='teleop',
                    namespace='/b',
                    parameters=[{
                        'publish_rate': 125.0,
                    ...
                    remappings=[
                        # ('haptic_pose', '/b/omega_7__right_hand_00/measured_cp'),
